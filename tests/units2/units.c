...
#define TST_KEY_A {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f}
#define TST_KEY_B {0xF0, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f}

const SkyHMACKey keys_a[1] = { {.key = TST_KEY_A, .len = sizeof(key_a)} };
const SkyHMACKey keys_b[1] = { {.key = TST_KEY_B, .len = sizeof(key_b)} };
const SkyHMACKey keys_ab[2] = { {.key = TST_KEY_A, .len = sizeof(key_a)}, {.key = TST_KEY_B, .len = sizeof(key_b)} };
const SkyHMACKey keys_ba[2] = { {.key = TST_KEY_B, .len = sizeof(key_b)}, {.key = TST_KEY_A, .len = sizeof(key_a)} };
