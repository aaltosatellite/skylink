...
TEST(vc_content_to_send){
	...
	ASSERT(handle->virtual_channels[0]->arq_state == ARQ_STATE_IN_INIT, "VC arq_state is not ARQ_STATE_IN_INIT, it is: %d", handle->virtual_channels[0]->arq_state);
	// Check that there is no content to send.
	...
	ASSERT(handle->virtual_channels[0]->arq_state == ARQ_STATE_ON, "VC arq_state is not ARQ_STATE_ON, it is: %d", handle->virtual_channels[0]->arq_state);
...
TEST(handle_handshake){
	...
	ASSERT(handle->virtual_channels[0]->arq_state == ARQ_STATE_OFF, "VC arq_state is not ARQ_STATE_OFF, it is: %d", handle->virtual_channels[0]->arq_state);
