...
if __name__ == '__main__':
	...
	parser.add_argument("--doppler", "-d", "-dc", action="store_true", help="Run modem with Doppler compensation, where observed freq. is used for velocity estimation and computing a doppler corrected TX frequency.")
	...
	modem.dsp_loop.set_doppler_correction(_args.doppler)
	try:
		while True:
