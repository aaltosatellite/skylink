...
from kuokka.lib_tools import make_samples2, DEFAULT_SYNCHWORD, DEFAULT_SYNCHWORD_LEN, ints_to_bits
import zmq
...
class UHFUsrpCharacterizer:
	...
	def _compose_samples(self, payload, f_tx_abs, baudrate, mod_index, BT, usrp_reshape, as_c64):
		...
		bits = frame_packet(pl=pl_char_ints, synchword_int=DEFAULT_SYNCHWORD, synchword_len=DEFAULT_SYNCHWORD_LEN, use_scrambler=True, use_rs=False, rs_mx=self.rs_mx, rs_cfg=self.rs_cfg, nrz_shift=True)
